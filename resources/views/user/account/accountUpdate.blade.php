                                ...
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="title-2">
                                            ...
                                            <span class="offset-4">Account Edit</span>
                                        </h3>
                                    </div>
                                    <hr>
                                    ...
                                    @if (session('success'))
                                        <div class="alert alert-success alert-dismissible fade show col-4 offset-8 mt-3" role="alert">
                                            <i class="fa-solid fa-circle-xmark"></i> {{ session('success') }}
                                            ...
                                            <div class="col-3 offset-1 ">
                                                @if (Auth::user()->image == null)
                                                    @if (Auth::user()->gender == 'Male')
                                                        <img src="{{ asset('image/Male_default.jpg') }}" alt="John Doe" class=" img-thumbnail" />
                                                    @else
                                                        <img src="{{ asset('image/Female_default.jpg') }}" alt="John Doe" class=" img-thumbnail" />
                                                    @endif
                                                @else
                                                    <img src="{{ asset('storage/profile_image/'.Auth::user()->image) }}" alt="John Doe" class=" img-thumbnail" />
                                                @endif
                                                <div class="mt-3">
                                                ...
                                                <div class="mt-3">
                                                    <button class="btn btn-primary col-12" type="submit"><span class="text-light">Update</span></button>
                                                </div>
