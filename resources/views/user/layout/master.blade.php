                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropstart">
                                <a class="btn btn-warning dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-user text-dark"></i> <span class="text-dark">{{ Auth::user()->name }}</span>
                                </a>

                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item my-2" href="{{ route('user#accountupdatePage') }}">
                                            <i class="fa-solid fa-user me-2"></i>Account
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item my-2" href="{{ route('user#passwordchangepage') }}">
                                    ...
                                    <li>
                                        <span class="dropdown-item my-2">
                                            <form action="{{ route('logout') }}" method="post">
                                                @csrf
                                                <button class="btn btn-outline-dark w-100"><i class="fa-solid fa-right-from-bracket me-2"></i>Logout</button>
                                            </form>
                                        </span>
                                    </li>
                                </ul>
                        ...
                        <form action="">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary"><span class="text-light">Sign Up</span></button>
                                </div>
                            </div>
                        </form>
